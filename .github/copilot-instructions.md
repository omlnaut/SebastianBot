...
- Avoid `sys.path` manipulation for imports. Always use absolute imports from the repository root.
...
- use specific names for the azure functions. i.e. instead of `main`, use `MangaUpdateFunction`.
