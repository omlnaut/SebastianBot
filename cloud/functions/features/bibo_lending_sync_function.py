...
def check_bibo_lending_sync(mytimer: TimerRequest) -> None:
    logging.info("BiboLendingSync (Sebastian) timer function processed a request.")
...
@app.timer_trigger(
    schedule=TriggerTimes.BiboLendingSyncWife,
    arg_name="mytimer",
    run_on_startup=False,
    use_monitor=False,
)
def check_bibo_lending_sync_wife(mytimer: TimerRequest) -> None:
    logging.info("BiboLendingSync (Wife) timer function processed a request.")
